export default {
  ...
  agentEditor: {
    ...
    desc: {
      ...
      webFetchEnabled: '리랭크 후 상위 웹 페이지의 전체 콘텐츠를 자동으로 가져와 답변 품질을 높입니다',
      webFetchTopN: '리랭크 후 전체 콘텐츠를 가져올 최대 웹 페이지 수',
    ...
    im: {
      ...
      wechatScanBind: "QR 코드를 스캔하여 위챗 연결",
      wechatScanning: "위챗으로 QR 코드를 스캔하세요",
      wechatBindSuccess: "위챗이 연결되었습니다",
      wechatRebind: "다시 연결",
      wechatHint: "iOS 위챗 8.0.70 이상이 필요하며, 1:1 채팅 메시지만 지원됩니다",
